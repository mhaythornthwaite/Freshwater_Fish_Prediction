...
from fish_functions import print_tf_setup, open_jpeg_as_np, gen_data_array_vector, n_retraining, smooth_filter 
import copy
...
ax.set_ylim([np.nanmin(metrics_dict_smooth['train_loss_mean'])-0.5, np.nanmin(metrics_dict_smooth['train_loss_mean'])+4])
